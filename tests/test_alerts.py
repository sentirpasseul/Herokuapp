...
class TestAlerts:
    ...
    def test_alert_manual(self):
        ...
        assert self.alerts_page.get_alert_text() == TestAlertsData.ALERT_TEXT, "Ошибка при проверке текста алерта"
        self.alerts_page.accept_alert()
    ...
    def test_confirm_manual(self):
        ...
        assert self.alerts_page.get_alert_text() == TestAlertsData.CONFIRM_TEXT, \
    ...
    def test_prompt_manual(self):
        ...
        assert self.alerts_page.get_alert_text() == TestAlertsData.PROMPT_TEXT, \
